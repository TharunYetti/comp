...
Install the MCP server as a Desktop Extension using the pre-built [`mcp-server.mcpb`](https://github.com/TharunYetti/comp/releases/download/v0.2.6/mcp-server.mcpb) file:

Simply drag and drop the [`mcp-server.mcpb`](https://github.com/TharunYetti/comp/releases/download/v0.2.6/mcp-server.mcpb) file onto Claude Desktop to install the extension.
